...
From the invitation email, click the link to **create a free account** on the official Plex.tv site or sign into your account if you have one.
2. **Get the Plex App:**  
Install the app on your streaming device of choice and sign in.
3. **Update the Quality Settings:** _(optional but important)_  
In the app's Settings menu, look for the "Quality" or "Video" section and [set the quality to "Original" or "Maximum"](quality-settings.md) — otherwise Plex defaults to low-resolution video.
4. **Pin My Server** so you can find stuff:  
This looks a little different on each device, but generally: open the navigation, select "More", <a href="https://support.plex.tv/articles/customizing-the-apps/#toc-0" target="_blank">pin my libraries for quick access</a>, and unpin Plex's default "Movies & Shows" and "Live TV" links.
...
1. **I will never have every movie ever made.**
   * Let me know if there's something you'd like to see and I'll try to find it!
   * My goal is to reduce the need for multiple streaming services, but I can't realistically have every title ever produced.
...
An analogy I like: **my Plex is like a backyard pool shared with friends.**
...
## Using Plex
It's very similar to Netflix or other streaming services you've used before.
